    ...
    <div className={styles.MasterData}>
      ...
      <div className={styles.Column}>
        ...
        <Typography className={styles.Text}>
          Мануэль душ Рейш Машаду, больше известный как Местре Бимба, родился в
    ...
    <div className={styles.MasterData}>
      ...
      <div className={styles.Column}>
        ...
        <Typography className={styles.Text}>
          ...
          а бой второстепенен. Движения в этом стиле более планые и медленные.
        </Typography>
      </div>
      <div className={styles.Column}>
        <Typography component="h2" weight="demiBold" className={styles.Heading}>
  ...
  return (
    <div className={styles.MasterData}>
      ...
      <div className={styles.Column}>
        ...
        <Typography className={styles.Text}>
          Рейнальду Рамус Суазуна родился в Итабуне, Бразилия. С детства у него
          были проблемы с ногами, и доктор посоветовал заниматься спортом. Так
          Рейнальду познакомился с капоэйрой.
        </Typography>
        <Typography className={styles.Text}>
          ...
          времени. Суазуна отправился в Сальвадор, где учился у великих
          мастеров: Местре Бимба, Канжикинья, Паштинья, Вальдемара и других.
        </Typography>
        <Typography className={styles.Text}>
          В 1970-х Местре Суазуна разработал стиль Миудинью (Capoeira Miudinho).
          Это стиль игры с более быстрыми движениями, а также большим вниманием
          к ритму и музыкальности. При этом соперники находятся очень близко
          друг к другу, так что места для маневра немного.
        </Typography>
        <Typography className={styles.Text}>
          Суазуна учил необходимости постоянно практиковаться, владеть
