  ...
  return (
    <div className={styles.MasterData}>
      ...
      <div className={styles.Column}>
        ...
        <Typography className={styles.Text}>
          Рейнальду Рамус Суассуна родился в Итабуне, Бразилия. С детства у него
        ...
        <Typography className={styles.Text}>
          ...
          Miudinho). Это стиль игры с более быстрыми движениями, а также большим
          вниманием к ритму и музыкальности. При этом соперники находятся очень
          близко друг к другу, так что места для маневра немного.
        </Typography>
        <Typography className={styles.Text}>
